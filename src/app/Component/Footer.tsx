...
import { FOOTER_CONTACT_INFO, FOOTER_LINKS, SOCIALS } from "../../../Constent";
import { link } from "fs";
  ...
  return (
    <footer className="flexCenter mb-24">
      <div className="padding-container max-container flex flex-col w-full gap-14">
          ...
          <div className="flex flex-wrap gap-10 sm:justify-between md:flex-1">
            ...
            <div className="flex flex-col gap-5">
              <FooterColumn title={SOCIALS.title}>
                <ul className="regular-14 gap-4 text-gray-30 flex">
        ...
        <p className="regular-14 text-gray-30 text-center w-full">
